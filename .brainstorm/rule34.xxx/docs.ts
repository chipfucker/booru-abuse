namespace Rule34 {
    ...
    declare interface BaseQueryValueOptions {
        key: QueryValueKey
    ...
    declare interface QueryValueOptions extends BaseQueryValueOptions {
        comparison?: QueryValueComparison.EqualTo,
    }

    /** An interface for value comparison queries. */
    declare interface QueryValueComparisonOptions extends BaseQueryValueOptions {
        key:
            | QueryValueKey.Width
