...
export enum TagType {
    ...
    Character,
    /**
     * An artist alias, or a tag asking for help finding and tagging with the correct
     * artist, such as `artist_request`.
     */
    Artist,
    /**
     * A visual, activity, interest, or a tag that otherwise wouldn't suit any other
     * tag type.
     */
    General,
    /**
     * Image metadata, such as dimensions, animation, or calls for help, such as
     * `tagme`.
     */
    Metadata,
    /**
